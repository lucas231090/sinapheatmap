          ...
          participants.map((participant) => (
            ...
            >
              <input
                ...
                placeholder="Nome"
                className="w-full rounded-2xl border border-black/15 bg-slate-100 px-3 py-2 text-sm text-black placeholder:text-slate-500 focus:border-cyan-500 focus:outline-none"
              />
              <input
