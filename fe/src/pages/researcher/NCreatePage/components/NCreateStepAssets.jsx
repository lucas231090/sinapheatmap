    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <SamplesPanel
          ...
          onSampleDraftChange={onSampleDraftChange}
          onSampleSave={onSampleSave}
          onSampleCreateNew={onSampleCreateNew}
        ...
        <PiecesPanel
          ...
          onPieceDraftChange={onPieceDraftChange}
          onPieceSave={onPieceSave}
          onPieceCreateNew={onPieceCreateNew}
          onPieceSelect={onPieceSelect}
          onPieceDelete={onPieceDelete}
  ...
  return (
    <CardPanel className="space-y-4">
      ...
      <InputField
        ...
        onChange={(event) => onSampleDraftChange("name", event.target.value)}
        placeholder="Ex: Azul"
      />
      <TextAreaField
        label="Descrição"
        ...
        {samples.length ? (
          samples.map((sample) => (
            <RowCard
              ...
              badge={`${
                pieces.filter((piece) => piece.sampleId === sample.id).length
              } peça(s)`}
        ...
        <>
          ...
          <InputField
            ...
            onChange={(event) => {
              ...
              onPieceDraftChange("sourceType", value.trim() ? "url" : "file");
              if (value.trim()) {
                onPieceDraftChange("sourceLabel", "");
                onPieceDraftChange("fileName", "");
                onPieceDraftChange("mimeType", "");
