...
const GazePlot = ({
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        {/* Arrow marker definitions per session */}
        <defs>
        ...
        {/* Saccade lines with directional arrows */}
        {Object.entries(sessionFixationGroups).map(
          ([sessionId, sessionFixes]) =>
        ...
        {/* Fixation circles — reversed so first appear on top */}
