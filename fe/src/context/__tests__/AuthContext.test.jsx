...
describe("AuthContext", () => {
  ...
  test("handles loading state", async () => {
    ...
    // O componente AuthProvider deve mostrar "Carregando..." enquanto isAuthenticated está pendente
    // Como nosso mock não é assíncrono neste teste específico, o estado de carregamento pode ser muito breve
    // Este test seria mais efetivo se pudéssemos espiar o estado interno do componente
