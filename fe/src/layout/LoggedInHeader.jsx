...
function LoggedInHeader({ body }) {
  ...
  return (
    <header className="bg-white dark:bg-gray-800 text-black dark:text-white flex flex-row justify-start p-4 pb-0 items-center transition-colors duration-300">
