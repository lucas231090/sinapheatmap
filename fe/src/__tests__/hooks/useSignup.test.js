...
describe('useSignup', () => {
    ...
    it('should register user successfully when passwords match', async () => {
        ...
        expect(registerUser).toHaveBeenCalledWith('João', 'joao@test.com', 'senha123');
    ...
    it('should handle registration error', async () => {
        ...
        expect(result.current.error).toBe('Erro ao registrar. Verifique seus dados e tente novamente.');
    ...
    it('should set loading state during registration', async () => {
        ...
        let resolveRegister;
        registerUser.mockReturnValue(new Promise(resolve => {
