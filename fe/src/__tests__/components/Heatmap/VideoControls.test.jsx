...
jest.mock("@/components/HeatmapStatic/TestSelector", () => {
...
describe("VideoControls Component", () => {
  ...
  test("starts video when test is selected", () => {
    ...
    // Simula a seleção de um teste (mudando a prop currentTestIndex)
    rerender(<VideoControls {...defaultProps} currentTestIndex="0" />);
  ...
  test("doesn't restart video if already started", () => {
    ...
    const component = render(
      <VideoControls {...defaultProps} currentTestIndex="0" />
    );
